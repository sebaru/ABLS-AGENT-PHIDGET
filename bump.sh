...
Behavior:
  ...
  - Copies produced RPMs from ABLS-AGENT-PHIDGET/build to ABLS-PKGS/public/rpms/<arch>
  - Copies produced DEBs from ABLS-AGENT-PHIDGET/build/deb/<suite>/<arch> to ABLS-PKGS/deb-packages/<suite>/
